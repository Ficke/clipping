...
const albumPhoto = z.object({
  ...
  photoId: z.string().refine((value) => isPhotoId(value), 'must look like photo_<24 hex characters>'),
...
const albums = defineCollection({
  ...
  schema: z.object({
    ...
    cover: z.string().refine((value) => isPhotoId(value), 'must be a photo ID').optional(),
